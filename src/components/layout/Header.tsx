...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur-md border-b border-gray-800 shadow-lg shadow-purple-500/10">
      <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#databases" className="text-gray-300 hover:text-purple-400 transition-colors font-medium">
              Databases
            </a>
            ...
            {isAuthenticated && user ? (
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="flex items-center space-x-2 text-gray-300 hover:text-purple-400 font-semibold transition-colors">
                ...
                {/* Dropdown Menu */}
                {showDropdown && (
                  <div className="absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-2xl shadow-purple-500/20 py-2 border border-gray-700">
                    <Link
                      to="/dashboard"
